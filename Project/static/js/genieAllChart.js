...
window.addEventListener('DOMContentLoaded', () => {
    ...
    let info = pageAlgoGenie(ejsDataGenie.length, 3, viewCount, 1);

    // 페이지 버튼 출력 함수
    function pageBtnGenie(info) {
        ...
        if(info.cursor == info.totalPageSize) {
            ...
            temp += `<li class="page-item" onclick="pageBtnMoveGenie('${info.totalPageSize}', ${viewCount})">
                    <a class="page-link">next</a>
                </li>
            </ul>
            </td>`;
